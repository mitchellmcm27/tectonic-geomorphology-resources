...
**[WorldClim](http://www.worldclim.org/)** Gridded climatic data with ~1 km resolution ([Fick and Higmans, RMetS, 2017]({{ site.baseurl }}/Fick_et_al-2017-International_Journal_of_Climatology.pdf)).
